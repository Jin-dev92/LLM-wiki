---
type: source
title: 김의진 이력서 — 풀스택 개발자 (2026, 개선안)
summary: 원본(PDF 1:1)을 채용담당자 관점 가이드 기준으로 개선한 이력서 사본. 상단 임팩트 헤드라인, 문제→대처→결과 재구성, 차별화 경험(자동화) 상단 노출.
created: 2026-06-19
updated: 2026-06-19
visibility: private
url:
...
> **이 파일은 원본 `../resume-fullstack-2026.md`(PDF 1:1)의 개선 사본이다.** (수정일: 2026-06-19)
...
- **AI/LLM 프로덕션 적용**: Gemini 기반 전자 차트 요약 자동화·시술 추천 AI 서버 1인 구축 — PII 마스킹 프롬프트 파이프라인 + 사내 지식 위키 grounding으로 할루시네이션·비용 최적화
...
- 사내 LLM 지식 위키를 구축해 AI 응답을 위키 근거로 grounding — 할루시네이션을 줄이고 컨텍스트 토큰·비용 최적화
...
- [[resume-writing-principles]] — 이 개선안에 적용한 이력서 작성 원칙
