---
type: rule
title: Java/Spring 백엔드 규칙
summary: Java/Spring 표준 — QueryDSL, DTO record, DDD 패키지, EntityChangeLog, Jackson/JsonNaming, Exception/Logging, Spotless, Liquibase, REST/Service 네이밍.
created: 2026-06-18
updated: 2026-06-18
visibility: team
scope: stack
applies_to: [java, spring, querydsl, jpa, liquibase]
tags: [backend, java, spring, rules]
source_file: iCloud/claude/docs/team-java-rules.md (Java/JSON/Exception/Logging/DB/API 섹션)
---
