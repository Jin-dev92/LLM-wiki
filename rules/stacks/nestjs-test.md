---
type: rule
title: NestJS 테스트 코드 규칙
summary: NestJS 단위/통합/e2e 테스트 규칙 — AAA 패턴, 테스트 격리, mocking(Partial<jest.Mocked<T>>), 픽스처 factory, DI 테스트모듈.
created: 2026-06-18
updated: 2026-06-18
visibility: team
scope: stack
applies_to: [nestjs, jest, testing]
tags: [backend, nestjs, test, rules]
source_file: iCloud/claude/docs/nestjs-test-rules.md
---
